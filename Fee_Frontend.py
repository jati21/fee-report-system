    ...
    def __init__(self, master):
        ...
        def Receipt():
            ...
            self.Display.insert(END, '\tStudent Name  :' +
                                self.name.get() + '\n')
            self.Display.insert(END, '\tStudent uid.\t:' +
                                self.admsn.get() + '\n')
            self.Display.insert(
        ...
        # ==================================================Frames===================================================
        Main_Frame = Frame(self.master, bg='snow3')
        Main_Frame.grid()

        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='snow3', relief='ridge', bd=15)
        ...
        Data_Frame = Frame(Main_Frame, width=1350, height=350,
                           bg='snow3', relief='ridge', bd=15)
        Data_Frame.pack(side=TOP, padx=15)

        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='snow3', relief='ridge', bd=8,
                             text='Informations', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='snow3', relief='ridge', bd=8,
        ...
        self.admsn_label = Label(Frame_1, text='Student UID : ', font=(
            'arial', 14, 'bold'), bg='snow3')
        ...
        # ==================================================Entries=================================================
        self.var_1 = DoubleVar(Frame_1, value='80000')
